...
import { CheckCircle2, LineChart, Users, Megaphone } from "lucide-react";
import { pageMetadata } from "@/lib/seo";

export const metadata = pageMetadata({
  title: "CRM Development & Integration | Speion",
  description: "Custom Customer Relationship Management software. Boost sales conversions, track leads, and improve customer retention.",
    ...
    <main className="min-h-screen relative bg-slate-50 dark:bg-slate-950">
      ...
      <section className="pt-40 pb-20 px-4 sm:px-6 relative overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-slate-950 text-white">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold mb-8 tracking-tight">
            Accelerate <span className="text-teal-300">Sales Growth</span>
          </h1>
          <p className="text-lg md:text-xl text-blue-100 font-light leading-relaxed max-w-3xl mx-auto mb-10">
            A CRM that actually fits your sales process. We build custom CRM platforms to help you track leads, close deals faster, and retain customers through automated workflows.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Lead Tracking & Pipelines", desc: "Visualize your entire sales pipeline with drag-and-drop interfaces and automated lead scoring.", icon: <LineChart size={24} /> },
              { title: "Marketing Automation", desc: "Trigger automated email sequences and SMS campaigns based on user behavior.", icon: <Megaphone size={24} /> },
              { title: "Customer Portals", desc: "Secure portals for your clients to track their orders, view invoices, and submit support tickets.", icon: <Users size={24} /> },
            ].map((feat, idx) => (
      ...
      <section className="py-20 px-4 sm:px-6 bg-slate-100 dark:bg-slate-900/50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-8">Why Invest in a Custom CRM?</h2>
          <div className="grid sm:grid-cols-2 gap-4 text-left">
            {[
              "No Per-User Licensing Fees",
              "Tailored to Your Exact Sales Process",
              "Higher Adoption Rates by Staff",
