    ...
    <main className="min-h-screen relative bg-slate-50 dark:bg-slate-950">
      ...
      <section className="pt-40 pb-20 px-4 sm:px-6 relative overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-slate-950 text-white">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold mb-8 tracking-tight">
            Native & Cross-Platform <span className="text-teal-300">Apps</span>
          </h1>
          <p className="text-lg md:text-xl text-blue-100 font-light leading-relaxed max-w-3xl mx-auto mb-10">
            Reach your users on any device. We build highly scalable, intuitive, and feature-rich mobile applications for iOS and Android using React Native and native code.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "React Native & Flutter", desc: "Write once, deploy everywhere. We use modern cross-platform frameworks to reduce costs and time-to-market.", icon: <Code2 size={24} /> },
              { title: "iOS & Android Native", desc: "For apps requiring intense hardware utilization, we write performant native Swift and Kotlin code.", icon: <Smartphone size={24} /> },
              { title: "App Store Optimization", desc: "We ensure your app is approved quickly and optimized for visibility in both Google Play and the App Store.", icon: <MonitorSmartphone size={24} /> },
            ].map((feat, idx) => (
      ...
      <section className="py-20 px-4 sm:px-6 bg-slate-100 dark:bg-slate-900/50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-8">Why Speion for Mobile Apps?</h2>
