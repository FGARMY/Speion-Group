...
export const metadata = pageMetadata({
  title: "UI/UX Design Services | Pixel-Perfect Interfaces | Speion",
  description: "Speion engineers stunning, intuitive, and conversion-optimized user interfaces tailored for seamless user journeys.",
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] dark:bg-[#020617] selection:bg-rose-500/30">
      <ServicePageSchema
        ...
        serviceDescription="Speion engineers stunning, intuitive, and conversion-optimized user interfaces tailored for seamless user journeys."
        pathname="/services/ui-ux-design"
        faqs={[
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm mb-8">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-800 dark:text-slate-200">UI/UX Design</span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-slate-900 dark:text-white leading-[1.1] tracking-tight mb-8 max-w-5xl">
              Pixel-Perfect <br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 font-light leading-relaxed max-w-3xl mb-12">
              We engineer intuitive, accessible, and stunning user interfaces that convert. From complex SaaS dashboards to premium corporate websites, our design system ensures seamless journeys.
            </p>
