        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-slate-900 dark:text-white leading-[1.1] tracking-tight mb-8">
              Enterprise Transformation <br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 font-light leading-relaxed max-w-2xl mb-12">
              Full-scale digital modernization for legacy businesses. Upgrade to cloud-native architectures and autonomous AI workflows.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800">
              <ul className="space-y-4">
                {['Full Custom ERP/CRM Development', 'Legacy System to Cloud Migration', 'Advanced AI Automations & Workflows', 'Dedicated Enterprise Engineering Team', '24/7 Priority Support SLA', 'Enterprise-Grade Security Auditing', 'Custom Staff Training & Onboarding'].map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-lg text-slate-700 dark:text-slate-300 font-medium">
                    <CheckCircle2 size={24} className="text-indigo-500 shrink-0" /> {item}
                  </li>
                ))}
              </ul>
            </div>
