      ...
      <div className="container mx-auto max-w-5xl">
        <div className="bg-gradient-to-br from-rose-50 via-rose-100 to-white dark:from-slate-900 dark:via-rose-950 dark:to-slate-950 border border-rose-200 dark:border-none rounded-[3rem] p-10 md:p-20 text-center shadow-[0_30px_100px_rgba(225,29,72,0.1)] dark:shadow-[0_30px_100px_rgba(225,29,72,0.25)] relative overflow-hidden group opacity-0 animate-fade-in-up transition-all duration-500">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-rose-600/10 dark:bg-white/20 backdrop-blur-md text-rose-700 dark:text-white px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest mb-8 border border-rose-600/20 dark:border-none">
              <CalendarPlus size={14} className="text-rose-600 dark:text-rose-200" />
              Free Architecture Audit
            </div>
            <h2 className="text-4xl md:text-6xl font-display font-bold text-slate-900 dark:text-white mb-8 tracking-tightest leading-[1.05]">
            ...
            <p className="text-slate-700 dark:text-rose-50/90 text-lg md:text-2xl font-light mb-12 leading-relaxed max-w-2xl mx-auto">
