  ...
  return (
    <section id="appointment" className="py-24 px-4 sm:px-6 relative bg-white dark:bg-[#020617] transition-colors duration-500">
      <div className="container mx-auto max-w-5xl">
        <div className="bg-gradient-to-br from-slate-900 via-rose-900 to-slate-900 dark:from-slate-900 dark:via-rose-950 dark:to-slate-950 rounded-[3rem] p-10 md:p-20 text-center shadow-[0_30px_100px_rgba(225,29,72,0.25)] relative overflow-hidden group opacity-0 animate-fade-in-up transition-all duration-500">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md text-white px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest mb-8">
              <CalendarPlus size={14} className="text-rose-200" />
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-8 tracking-tightest leading-[1.05]">
              Stop Managing Debt <br className="hidden md:block" /> — <span className="text-rose-200">Start Engineering ROI.</span>
            </h2>
            <p className="text-rose-50/90 text-lg md:text-2xl font-light mb-12 leading-relaxed max-w-2xl mx-auto">
              Secure an elite engineering pod and modernize your architecture today.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a href="/contact" className="w-full sm:w-auto bg-white dark:bg-slate-100 text-rose-900 px-10 py-5 rounded-full font-bold shadow-2xl hover:bg-slate-50 dark:hover:bg-white transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3 text-lg">
